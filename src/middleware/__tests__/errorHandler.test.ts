...
import { errorHandlerMiddleware, setupSentryErrorHandler } from '../errorHandler';
...
describe('errorHandlerMiddleware', () => {
  ...
  describe('Sentry integration', () => {
    ...
    it('should set Sentry tags for filtering', () => {
      ...
      expect(Sentry.setTag).toHaveBeenCalledWith('error_category', ErrorCategory.VALIDATION);
      expect(Sentry.setTag).toHaveBeenCalledWith('status_code', 400);
      expect(Sentry.setTag).toHaveBeenCalledWith('correlation_id', 'test-correlation-id');
    });
