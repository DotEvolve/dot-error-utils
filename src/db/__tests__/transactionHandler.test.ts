...
describe('withTransaction', () => {
  ...
  describe('Prisma transaction integration', () => {
    ...
    it('should handle Prisma transaction errors', async () => {
      ...
      await expect(
        withTransaction(mockPrisma, mockCallback)
      ).rejects.toThrow('Prisma constraint violation');
  ...
  describe('TypeScript generics', () => {
    it('should preserve return type', async () => {
      ...
      const result: User = await withTransaction<User>(mockPrisma, mockCallback);
    ...
    it('should work with different return types', async () => {
      ...
      const arrayResult = await withTransaction<number[]>(mockPrisma, mockCallback);
